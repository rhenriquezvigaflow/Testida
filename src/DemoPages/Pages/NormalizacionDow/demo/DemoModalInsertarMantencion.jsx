...
const ModalInsertarMantencion = (props) => {
  ...
  const [showInsertarMantencion, setShowInsertarMantencion] = useState(true);
  ...
  return (
    <Modal
      ...
      <Grid
        ...
        <Grid item>
          <div
            className={"modal-cirle"}
            style={{ backgroundColor: "#2f4554" }}>
            <IconoMantenciones style={{ color: "#fff" }} />
          </div>
        </Grid>
        <Grid item />
        <Grid item>
...
export default ModalInsertarMantencion;
