...
import ScadaMowi from "./ScadaMowi";
...
const Mowi = () => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Mowi-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
    ...
    <>
      ...
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem>Mowi</BreadcrumbItem>
      ...
      >
        ...
        <Tarjetita
          number={15}
          name="Diferencial de Presión (filtros)"
        ...
        <Tarjetita
          number={16}
          name="Diferencial de Presión (f. cartucho)"
