...
import ScadaKoAndinaAntofagasta from "./ScadaKoAndinaAntofagasta";

const KoAndinaAntofagasta = () => {
  const idPlanta = 42;
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `KoAndinaAntofagasta-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
    ...
    fetch(apis.loadScadaWithMult, {
      ...
      .then((json) => {
        ...
        if (json.length > 0) {
          ...
          setDatosScada({ ...datosScada, con: 2 });
        }
      })
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta KO Andina Antofagasta
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          <BreadcrumbItem>IdA</BreadcrumbItem>
          <BreadcrumbItem>Plantas</BreadcrumbItem>
          <BreadcrumbItem>KO Andina Antofagasta</BreadcrumbItem>
...
export default KoAndinaAntofagasta;
