...
export const Mission3 = ({ idPlanta = 230 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Terranova-3-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta Blueberries Perú - Terranova 3
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem active>SCADA Terranova 3</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
