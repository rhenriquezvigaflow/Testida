...
export const Scada = (props) => {
  ...
  const diferencialFiltroF200 =
    datosScada !== null && getScaledValue(datosScada.d11, 1);
  const diferencialFiltroF201 =
  ...
  const diferencialFiltroF202 =
    datosScada !== null && getScaledValue(datosScada.d14, 1);
  const diferencialFiltroF203 =
  ...
  return (
    <svg
      ...
      {/* Diferencial Filtro F200 */}
      <g
        style={{ cursor: "pointer" }}
        onClick={() => loadGrafico(10, "Diferencial Filtro F200", false)}>
        <path
        ...
        g-{/* Alarma Diferencial Filtro F200 */}
        <g
          className={getTemaAlarma(10, loading, datosAlarmas)}
          onClick={(e) => {
            e.stopPropagation();
            onClickAlarma(10, "Diferencial Filtro F200");
          }}>
          <path
      ...
      />
      {/* Diferencial Filtro F201 */}
      <g
        style={{ cursor: "pointer" }}
        onClick={() => loadGrafico(11, "Diferencial Filtro F201", false)}>
        <path
        ...
        {/* Alarma Diferencial Filtro F201 */}
        <g
          className={getTemaAlarma(11, loading, datosAlarmas)}
          onClick={(e) => {
            e.stopPropagation();
            onClickAlarma(11, "Diferencial Filtro F201");
          }}>
          <path
      ...
      />
      {/* Diferencial Filtro F202 */}
      <g
        style={{ cursor: "pointer" }}
        onClick={() => loadGrafico(14, "Diferencial Filtro F202", false)}>
        <path
        ...
        {/* Alarma Diferencial Filtro F202 */}
        <g
          className={getTemaAlarma(14, loading, datosAlarmas)}
          onClick={(e) => {
            e.stopPropagation();
            onClickAlarma(14, "Diferencial Filtro F202");
          }}>
          <path
      ...
      />
      {/* Diferencial Filtro F203 */}
      <g
        style={{ cursor: "pointer" }}
        onClick={() => loadGrafico(15, "Diferencial Filtro F203", false)}>
        <path
        ...
        {/* Alarma Diferencial Filtro F203 */}
        <g
          className={getTemaAlarma(15, loading, datosAlarmas)}
          onClick={(e) => {
            e.stopPropagation();
            onClickAlarma(15, "Diferencial Filtro F203");
          }}>
          <path
