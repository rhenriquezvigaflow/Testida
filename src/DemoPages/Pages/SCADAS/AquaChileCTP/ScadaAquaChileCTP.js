    ...
    <svg
      ...
      >
        ...
        <text
          ...
          className="st7 st8 st21">
          {getScaledValue(
            datosScada.d7 > 0 ? (datosScada.d17 / datosScada.d7) * 100 : 0,
            1
          )}
        </text>
        <text
      ...
      <g
        ...
        onClick={() => {
          onClickAlarma(17, "Caudal de Permeado");
        }}>
      ...
      <g
        ...
        <text
          ...
          className="st7 st8 st21">
          {getScaledValue(datosScada.d7 - datosScada.d17, 1)}
        </text>
        <text
      ...
      <g
        ...
        /* onClick={() => {onClickAlarma(8,"Caudal de Rechazo")}} */
      >
      ...
      <g
        className="cursorPointer"
        onClick={() => loadGrafico(15, "ORP Permeado", false)}>
        <path
