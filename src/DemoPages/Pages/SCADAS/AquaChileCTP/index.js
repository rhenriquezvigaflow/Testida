...
import ScadaAquaChileCTP from "./ScadaAquaChileCTP.js";
...
const AquaChileCTP = () => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `AquaChileCTP-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
    ...
    <>
      ...
      <Grid
        ...
        <Tarjetita
          ...
          value={(datosScada.d7 - datosScada.d17).toFixed(1)}
          selected={Number(selected)}
          max={umbrales.ma8}
          min={umbrales.mi8}
          unit="m³/h"
      ...
      <Grid
        ...
        <Tarjetita
          ...
          value={
            datosScada.d7 > 0
              ? ((datosScada.d17 / datosScada.d7) * 100).toFixed(1)
              : 0
          }
          selected={Number(selected)}
          max={umbrales.mi20}
