...
import ScadaNanoConcon from "./ScadaNanoConcon";
...
const NanoConcon = () => {
  ...
  const [datosFuncionamientoPlantaNano01, setDatosFuncionamientoPlantaNano01] =
    useState([]);
  const [datosFuncionamientoPlantaNano02, setDatosFuncionamientoPlantaNano02] =
    useState([]);
  const [
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `NanoConcon-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  const onClickBuscarDatos = () => {
    const funcionamientoNano01 = loadFuncionamientoPlanta(0);
    funcionamientoNano01.then((json) =>
      setDatosFuncionamientoPlantaNano01(json)
    );
    const funcionamientoNano02 = loadFuncionamientoPlanta(1);
    funcionamientoNano02.then((json) =>
      setDatosFuncionamientoPlantaNano02(json)
    );
  ...
  useEffect(() => {
    ...
    const funcionamientoNano01 = loadFuncionamientoPlanta(0, signal);
    const funcionamientoNano02 = loadFuncionamientoPlanta(1, signal);
    ...
    <>
      ...
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem>Nano Con Con</BreadcrumbItem>
      ...
      <Grid
        ...
        <Tarjetita
          number={7}
          name="Caudal de Alimentación (01)"
          value={datosScada.d7}
          selected={Number(selected)}
          max={umbrales.ma7}
          min={umbrales.mi7}
      ...
      >
        ...
        <Tarjetita
          number={14}
          name="Caudal de Alimentación (02)"
      ...
      <Card className="mb-3">
        <CardHeader className="card-header-tab">
          <div className="card-header-title font-size-md font-weight-bold">
            {"Funcionamiento de la Planta Nano 01"}
          </div>
        </CardHeader>
        <CardBody className="card-body-tab">
          <BarGraph
            data={datosFuncionamientoPlantaNano01}
            fecha={startDate}
            fechaFin={endDate}
          />
        </CardBody>
      ...
      <Card className="mb-3">
        <CardHeader className="card-header-tab">
          <div className="card-header-title font-size-md font-weight-bold">
            {"Funcionamiento de la Planta Nano 02"}
          </div>
        </CardHeader>
        <CardBody className="card-body-tab">
          <BarGraph
            data={datosFuncionamientoPlantaNano02}
            fecha={startDate}
            fechaFin={endDate}
          />
        </CardBody>
