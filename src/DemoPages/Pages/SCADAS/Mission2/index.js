...
import ScadaMission2 from "./ScadaMission2.js";
...
import { addDecimal } from "../../../../commons/lib/utils.js";
...
const Mission2 = ({ idPlanta = 70 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Mission-2-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta Blueberries Perú - Terranova 2
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          <BreadcrumbItem>IdA</BreadcrumbItem>
          <BreadcrumbItem>Plantas</BreadcrumbItem>
          <BreadcrumbItem>Blueberries Perú</BreadcrumbItem>
          <BreadcrumbItem active>SCADA Terranova 2</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
      ...
      <Grid
        ...
        <Tarjetita
          number={17}
          name="Diferencial Filtros High Flow"
      ...
      <Grid
        ...
        <Tarjetita
          ...
          value={addDecimal(calculosDiarios.volumen_alimentacion)}
          clickMe={() => {}}
          unit="m³"
        ...
        <Tarjetita
          ...
          value={addDecimal(calculosDiarios.volumen_permeado)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          number={23}
          name="Volumen Mezcla Diario"
          value={addDecimal(calculosDiarios.volumen_mezcla)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          ...
          value={addDecimal(calculosDiarios.vol_alimen_mensual)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          ...
          value={addDecimal(calculosDiarios.vol_permeado_mensual)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          number={26}
          name="Volumen Mezcla Mensual"
          clickMe={() => {}}
          value={addDecimal(calculosDiarios.vol_mezcla_mensual)}
          unit="m³"
          size="x-large-tarjeta">
          {" "}
        </Tarjetita>
          ...
          <Grid
            ...
            <section
              ...
              <div
                ...
                {titulo}
                {selected === 20 && <AverageDialogChart idPlanta={70} />}
              </div>
            </section>
