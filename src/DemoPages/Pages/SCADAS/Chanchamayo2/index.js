...
import { DialogTotalizadores } from "../../../../commons/components/dialog-totalizadores/DialogTotalizadores.jsx";
...
import { AverageDialogChart } from "../Mission/components/AverageDialogChart.jsx";
import ModalRangoGraficos from "../ModalRangoGraficos.jsx";
import { ScadaChanchamayo2 } from "./ScadaChanchamayo2.js";

const Chanchamayo2 = ({ idPlanta = 151 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Chanchamayo-2-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  // lógica para cuando un vibot se resetea y todos los valores quedan en 0
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta TA Export - Chanchamayo 2
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          <BreadcrumbItem>IdA</BreadcrumbItem>
          <BreadcrumbItem>Plantas</BreadcrumbItem>
          <BreadcrumbItem>TA EXPORT</BreadcrumbItem>
          <BreadcrumbItem active>SCADA Chanchamayo 2</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
      ...
      <Grid
        ...
        alignItems="center">
        <Tarjetita
          name="Conductividad de Alimentación"
          number={9}
          value={datosScada.d9}
          selected={Number(selected)}
          max={umbrales.ma9}
        ...
        />
        <Tarjetita
          name="Conductividad de Permeado"
          number={10}
        ...
        />
        <Tarjetita
          name="Diferencial Presión Filtros High Flow"
          number={17}
      ...
      <Grid
        ...
        <Tarjetita
          ...
          value={String(calculosDiarios.volumen_alimentacion)}
          unit="m³"
          clickMe={() => {}}
        ...
        <Tarjetita
          number={22}
          name="Volumen Permeado Diario"
          value={String(calculosDiarios.volumen_permeado)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          number={23}
          name="Volumen Producto Final Diario"
          value={String(calculosDiarios.volumen_mezcla)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          ...
          value={String(calculosDiarios.vol_alimen_mensual)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          number={25}
          name="Volumen Permeado Mensual"
          value={String(calculosDiarios.vol_permeado_mensual)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
        ...
        <Tarjetita
          number={26}
          name="Volumen Producto Final Mensual"
          value={String(calculosDiarios.vol_mezcla_mensual)}
          unit="m³"
          clickMe={() => {}}
          size="x-large-tarjeta">
          {" "}
      ...
      <Card className="mb-3">
        <Grid
          ...
          <Grid item>
            <div className="titles">
              <DialogTotalizadores idPlanta={idPlanta} />
            </div>
          </Grid>
        </Grid>
      </Card>
          ...
          <Grid
            ...
            <section
              ...
              <div
                ...
                {titulo}
                {selected === 15 && <AverageDialogChart idPlanta={151} />}
              </div>
            </section>
