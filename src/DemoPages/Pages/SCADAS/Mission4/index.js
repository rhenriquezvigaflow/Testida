...
export const Mission4 = ({ idPlanta = 250 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Terranova-4-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta Blueberries Perú - Terranova 4
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem active>SCADA Terranova 4</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
