...
import ScadaEmbonorTalca from "./ScadaEmbonorTalca.js";

const EmbonorTalca = ({ idPlanta = 28 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `EmbonorTalca-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
