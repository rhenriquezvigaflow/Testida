...
import ScadaAguasAndinasSIDP from "./ScadaAguasAndinasSIDP.js";

const AguasAndinasSIDP = () => {
  const idPlanta = 38;
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `AguasAndinasSantaInesDePataguilla-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta Aguas Andinas Santa Inés de Patagüilla
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem>
            Aguas Andinas Santa Inés de Patagüilla
          </BreadcrumbItem>
      ...
      <Grid
        ...
        <Tarjetita
          number={4}
          name="Diferencial Presión Primera Etapa"
          value={datosScada.d4}
          selected={Number(selected)}
          max={umbrales.ma4}
          min={umbrales.mi4}
      ...
      <Grid
        ...
        <Tarjetita
          number={11}
          name="Diferencial de Presión Segunda Etapa"
        ...
        <Tarjetita
          number={18}
          name="Concentración Nitratos Alimentación"
        ...
        <Tarjetita
          number={20}
          name="Concentración Nitratos Mezcla"
...
export default AguasAndinasSIDP;
