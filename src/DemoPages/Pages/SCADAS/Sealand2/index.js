...
import ScadaSealand2 from "./ScadaSealand2";
...
const Sealand2 = ({ idPlanta = 11 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Sealand-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
    ...
    <>
      ...
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem>Sealand</BreadcrumbItem>
      ...
      >
        ...
        <Tarjetita
          number={17}
          name="Cond. Agua Reconstituida Sala 1"
        ...
        <Tarjetita
          number={18}
          name="Cond. Agua Reconstituida Sala 2"
        ...
        <Tarjetita
          number={19}
          name="pH Agua Reconstituida Sala 1"
          ...
          <Grid item>
            <div className="date-range font-size-md">
              ...
              <DatePicker2
                ...
                calendarProps={{
                  min: new Date("2022-07-22 00:00:00"),
                  max: new Date(),
                  views: ["month"]
                }}
                messages={{
