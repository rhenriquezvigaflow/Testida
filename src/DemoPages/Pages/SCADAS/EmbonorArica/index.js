...
import ScadaEmbonorArica from "./components/ScadaEmbonorArica";

export default function EmbonorArica() {
  const idPlanta = 80;
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `EmbonorArica-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
