...
import { ScadaChanchamayo } from "./ScadaChanchamayo.js";

const Chanchamayo = ({ idPlanta = 150 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Chanchamayo-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta TA Export - Chanchamayo 1
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem active>SCADA Chanchamayo 1</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
          ...
          <Grid
            ...
            <section
              ...
              <div
                ...
                {titulo}
                {selected === 15 && <AverageDialogChart idPlanta={150} />}
              </div>
            </section>
