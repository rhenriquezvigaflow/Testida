...
import ScadaAlgortaNorte from "./ScadaAlgortaNorte";
...
const AlgortaNorte = ({ idPlanta = 2 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `AlgortaNorte-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      >
        ...
        <Tarjetita
          number={17}
          name="Presión Succión Bomba P-005"
