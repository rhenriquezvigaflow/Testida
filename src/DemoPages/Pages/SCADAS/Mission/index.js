...
import ScadaMission from "./ScadaMission";
...
import { AverageDialogChart } from "./components/AverageDialogChart.jsx";

const Mission = ({ idPlanta = 23 }) => {
  ...
  const exportarDatosScada = () => {
    ...
    const fileName = `Mission-${formatearFechaDDMMYY(startDate)}-${formatearFechaDDMMYY(endDate)}.xls`;
  ...
  return (
    <>
      ...
      <h1
        ...
        Planta Blueberries Perú - Terranova 1
      </h1>
      <div>
        <Breadcrumb className="Breadcrumb">
          ...
          <BreadcrumbItem active>SCADA Terranova 1</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <Grid
        container
          ...
          <Grid
            ...
            <section
              ...
              <div
                ...
                {titulo}
                {selected === 20 && <AverageDialogChart idPlanta={23} />}
              </div>
            </section>
